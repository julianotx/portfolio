        ...
        <section id="contact" className="py-28 px-6 bg-[#0a0a0f]">
            <div className="max-w-3xl mx-auto text-center">
                ...
                >
                    ...
                    <p className="text-blue-400 text-sm font-semibold tracking-widest uppercase mb-5 relative">Contato</p>

                    <h2 className="text-4xl md:text-5xl font-black text-white mb-5 relative">
                        Vamos trabalhar juntos?
                    </h2>

                    <p className="text-lg text-slate-400 mb-10 font-light leading-relaxed max-w-xl mx-auto relative">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4 relative">
                        ...
                        <a
                            ...
                            className="flex-1 sm:flex-none group flex flex-col items-center gap-3 p-6 rounded-2xl bg-[#25D366]/10 border border-[#25D366]/30 hover:bg-[#25D366]/20 hover:border-[#25D366]/50 transition-all"
                        >
                            ...
                            <div>
                                ...
                                <p className="text-[#25D366] text-xs mt-0.5">+55 11 98659‑8865</p>
                            </div>
                        </a>
                        ...
                        <a
                            ...
                            className="flex-1 sm:flex-none group flex flex-col items-center gap-3 p-6 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all"
                        >
                            ...
                            <div>
                                ...
                                <p className="text-slate-400 text-xs mt-0.5">julianogab.tx@gmail.com</p>
                            </div>
                        </a>
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex-1 sm:flex-none group flex flex-col items-center gap-3 p-6 rounded-2xl bg-[#0A66C2]/10 border border-[#0A66C2]/30 hover:bg-[#0A66C2]/20 hover:border-[#0A66C2]/50 transition-all"
                        >
                            ...
                            <div>
                                ...
                                <p className="text-[#0A66C2] text-xs mt-0.5">juliano-g-teixeira</p>
                            </div>
                        </a>
                    </div>
                </motion.div>
