...
export const HexGrid = () => {
    ...
    return (
        <div className="absolute inset-0 w-full h-full contain-paint overflow-hidden pointer-events-none select-none">
            <svg
                className="absolute inset-0 w-[120%] h-[120%] -left-[10%] -top-[10%] sm:w-full sm:h-full sm:left-0 sm:top-0"
